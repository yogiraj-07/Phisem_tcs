  ...
  if (analysis.links.length === 0) {
    return (
      <section aria-label="Local URL checks" className="rounded-xl border border-gray-200 bg-white p-5">
        <h3 className="font-bold text-text-main">Links in this message</h3>
        <p className="mt-2 text-sm text-text-muted">No HTTP, HTTPS or www links detected. Bare domains and hidden link targets are not inspected. No websites were opened or verified.</p>
      </section>
    );
  }
  return (
